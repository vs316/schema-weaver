...
const DEFAULT_ENABLE_UML = false;
const DEFAULT_ENABLE_FLOWCHART = false;
const DEFAULT_ENABLE_SEQUENCE = false;
...
export const FEATURE_FLAGS = {
  ...
  ENABLE_UML_DIAGRAMS: parseEnvBoolean(
    import.meta.env.VITE_ENABLE_UML_DIAGRAMS,
    DEFAULT_ENABLE_UML
  ),
  
  // Flowcharts - shows process flows with start/end, decisions, processes
  ENABLE_FLOWCHART_DIAGRAMS: parseEnvBoolean(
    import.meta.env.VITE_ENABLE_FLOWCHART_DIAGRAMS,
    DEFAULT_ENABLE_FLOWCHART
  ),
  
  // Sequence Diagrams - shows message flows between participants
  ENABLE_SEQUENCE_DIAGRAMS: parseEnvBoolean(
    import.meta.env.VITE_ENABLE_SEQUENCE_DIAGRAMS,
    DEFAULT_ENABLE_SEQUENCE
  ),
} as const;
